...
#BSP:modify lcm driver KFBHLJL-4 by meng.zhang 20200927 start
BOOT_LOGO = hdplus1600
#BSP:modify lcm driver KFBHLJL-4 by meng.zhang 20200927 end
BUILD_AGO_GMS = no
BUILD_KERNEL = yes
BUILD_LK = yes
BUILD_MD32 = no
BUILD_PRELOADER = yes
#BSP: add project macro by wanghanfeng 20200915 start
CUSTOM_BUILD_VERNO = CY-KF8-H696-A
#BSP: add project macro by wanghanfeng 20200915 start
...
#BSP: add KFBHLJL-6 by zhigang.yang for 20201010 start
CUSTOM_HAL_MSENSORLIB =
#BSP: add KFBHLJL-6 by zhigang.yang for 20201010 end
...
# BSP:modify CEJXLBQ-18 by shuanglei.wang 20190830 start
MTK_AUDIO_NUMBER_OF_MIC = 1
# BSP:modify CEJXLBQ-18 by shuanglei.wang 20190830 end
...
# BSP:modify CEJXLBQ-18 by shuanglei.wang 20190830 end
#SDD:modify TESSCR-1796 lijia.chen 2020.10.26 start
MTK_DURASPEED_DEFAULT_ON = no
MTK_DURASPEED_SUPPORT = no
#SDD:modify TESSCR-1796 lijia.chen 2020.10.26 end
...
MTK_FM_SUPPORT = yes
#TSD:add P1 test KFBHLJL-9 by huijun.shen 20201012 start
MTK_FM_GPIO_FUNC = yes
#TSD:add P1 test KFBHLJL-9 by huijun.shen 20201012 end
...
#TSD: modify VSIM TSDT-76 zhaopeng 20200706 start
#TSD: modify KFQHLEYJ-20 VSIM keyichen 20201020 start
MTK_MULTI_SIM_SUPPORT = dsds
#TSD: modify KFQHLEYJ-20 VSIM keyichen 20201020 end
#TSD: modify VSIM TSDT-76 zhaopeng 20200706 end
MTK_MUX_CHANNEL = 64
...
#TSD:modify KFBHLJL-33 for change sim onoff mode by qingming.song 2020.11.04 start
MTK_SIM_CARD_ONOFF = 1
#TSD:modify KFBHLJL-33 for change sim onoff mode by qingming.song 2020.11.04 end
...
#TCD:delete wma KFBHLJL-885 by lichen.yu 20201117 start
MTK_WMA_PLAYBACK_SUPPORT = no
#TCD:delete wma KFBHLJL-885 by lichen.yu 20201117 end
...
#BSP:modify lcm driver KFBHLJL-14 by meng.zhang 20201013 start
MTK_HIGH_FRAME_RATE = yes
#BSP:modify lcm driver KFBHLJL-14 by meng.zhang 20201013 end
...
#SDD: add for KFBHLJL-426 by yangjie 20201111 start
MTK_HIGH_FRAME_RATE_DEFAULT_FPS = 90
#SDD: add for KFBHLJL-426 by yangjie 20201111 end
...
MTK_TOUCHPANEL_KO =
#BSP: add project clone format by wanghanfeng 20200915 start
#BSP: add KFBHLJL-6 by zhigang.yang for 20201010 start
...
#BSP: add project clone format by wanghanfeng 20200915 end
#SDD: add project sw version by jiangping.guo 20200915 start
MTK_BUILD_VERNO=KF8-H696AB-R-TR-210419V67
TRAN_FINGERPRINT_BUILD_VERNO=210419V67
#SDD: add project sw version by jiangping.guo 20200915 end
#BSP: add project macro by wanghanfeng 20200915 start
CUSTOM_TRAN_PROJECT=tran_kf8
CUSTOM_TRAN_BOM=tran_kf8_a1
#BSP: add project macro by wanghanfeng 20200915 end
